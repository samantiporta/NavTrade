...
function Profile() {
  ...
  return (
    <div className="w-full">
      <h2 className="font-display text-xl font-semibold mb-6">Profile</h2>
      ...
      <div className="rounded-xl border border-[#131720] bg-[#080B10] p-8 mb-6">
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            {profile?.display_name && (
              <div className="text-sm text-[#5C6478]">{profile.email}</div>
            )}
        ...
        {profile?.bio && (
          <p className="text-sm text-[#7A8296] mt-6">{profile.bio}</p>
        )}
      </div>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#0B0E14] border border-[#232A38] rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#F0B429]"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#0B0E14] border border-[#232A38] rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#F0B429] resize-none"
            />
          </div>
          ...
          <button
            type="submit"
            className="flex items-center gap-2 bg-[#F0B429] hover:bg-[#E0A61E] text-[#05070B] font-medium text-sm px-6 py-3 rounded-lg transition-colors"
          >
